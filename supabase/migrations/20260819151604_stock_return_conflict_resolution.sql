-- Hosted Supabase does not allow the migration owner to set
-- plpgsql.variable_conflict. Keep the function portable instead: avoid a named
-- ON CONFLICT target that collides with OUT parameters and qualify balance
-- columns in UPDATE predicates.
